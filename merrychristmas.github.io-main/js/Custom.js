        ...
        if (bShowLetter == false) {
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        // Gộp nội dung thành 1 chuỗi và tắt loop/back để không xóa lại
                        strings: [
                            "<<< Merry Christmas >>><br>Hình như đã đến Giáng sinh rồi nhỉ <br> nay tụi con trai tụi tui sẽ mang đến một bất ngờ cho mọi người!! "
                        ],
                        typeSpeed: 1,
                        startDelay: 500,
                        // Không cấu hình backSpeed/backDelay và tắt loop
                        loop: false,
                        contentType: 'html',
                        showCursor: false
                    });
